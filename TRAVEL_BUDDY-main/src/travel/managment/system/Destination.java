...
public class Destination extends JFrame implements Runnable {
    ...
    public Destination() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/dest1.jpg"));
        Image i2 = i1.getImage().getScaledInstance(885, 680, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        l2 = new JLabel(i3);
        l2.setBounds(0, 0, 885, 680);
        add(l2);

        setLayout(null);

        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/dest2.jpg"));
        Image i5 = i4.getImage().getScaledInstance(885, 670, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        l3 = new JLabel(i4);
        l3.setBounds(0, 0, 885, 670);
        add(l3);
        l3.setVisible(false);
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icon/dest6.png"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icon/dest7.jpg"));
