...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            caption.setBounds(400,600,500,60);
    ...
    public CheckHotels() {
        ...
        Image i5 = i4.getImage().getScaledInstance(885, 680, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        l3 = new JLabel(i4);
        l3.setBounds(0, 0, 885, 680);
        add(l3);
        l3.setVisible(false);

        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel3.jpg"));
        Image i8 = i7.getImage().getScaledInstance(885, 680, Image.SCALE_DEFAULT);
        ImageIcon i9 = new ImageIcon(i8);
        l4 = new JLabel(i9);
        l4.setBounds(0, 0, 885, 680);
        add(l4);
        l4.setVisible(false);

        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel4.jpg"));
        Image i11 = i10.getImage().getScaledInstance(885, 660, Image.SCALE_DEFAULT);
        ImageIcon i12 = new ImageIcon(i11);
        l5 = new JLabel(i12);
        l5.setBounds(0, 0, 885, 660);
        add(l5);
        l5.setVisible(false);

        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel5.jpg"));
        Image i14 = i13.getImage().getScaledInstance(890, 680, Image.SCALE_DEFAULT);
        ImageIcon i15 = new ImageIcon(i14);
        l6 = new JLabel(i15);
        l6.setBounds(0, 0, 890, 680);
        add(l6);
        l6.setVisible(false);
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel8.jpeg"));
